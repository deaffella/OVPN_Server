...
OVPN_CONFIG_PATH = '/ovpn/openvpn.conf'
OVPN_SUBNET = open(OVPN_CONFIG_PATH, 'r').readline().removeprefix('server ').split(' ')[0]
...
if __name__ == '__main__':
    ...
    # echo_handler = MessageHandler(filters.TEXT & (~filters.COMMAND), text_handler)
